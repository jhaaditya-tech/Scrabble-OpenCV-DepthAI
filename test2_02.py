        ...
        if key == ord(" "):  # Spacebar to capture
            ...
            for contour in contours:
                ...
                if len(approx) == 4:
                    ...
                    # Shrink the quadrilateral to exclude the red border
                    shrink_margin = 20  # Adjust this based on the red border thickness

                    # Adjust each corner inward by the margin
                    src_pts = np.array([
                        [approx[0][0][0] + shrink_margin, approx[0][0][1] + shrink_margin],  # Top-left
                        [approx[1][0][0] - shrink_margin, approx[1][0][1] + shrink_margin],  # Top-right
                        [approx[2][0][0] - shrink_margin, approx[2][0][1] - shrink_margin],  # Bottom-right
                        [approx[3][0][0] + shrink_margin, approx[3][0][1] - shrink_margin]   # Bottom-left
                    ], dtype="float32")
