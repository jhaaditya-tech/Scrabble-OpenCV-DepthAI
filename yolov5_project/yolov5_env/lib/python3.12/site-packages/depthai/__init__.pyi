...
class CalibrationHandler:
    ...
    def getCameraIntrinsics(self, cameraId: CameraBoardSocket, resizeWidth: int = ..., resizeHeight: int = ..., topLeftPixelId: Point2f = ..., bottomRightPixelId: Point2f = ..., keepAspectRatio: bool = ...) -> list[list[float]]:
        ...
        1. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, resizeWidth: int = -1, resizeHeight: int = -1, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x104a592f0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x104a89530>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        2. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: depthai.Size2f, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x104a30930>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x104a3c970>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        3. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: tuple[int, int], topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x10490c0b0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x104a9cd70>, keepAspectRatio: bool = True) -> list[list[float]]
